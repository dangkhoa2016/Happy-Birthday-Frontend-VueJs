...
(async () => {
  ...
  const arrLibraries = [
    ...
    // 'npm/vue-i18n@8.27.2/dist/vue-i18n.js',
    'npm/moment@2.29.4/moment.min.js',
    'npm/moment@2.29.4/locale/vi.js',
    'npm/vue2-datepicker@3.11.0/index.min.js',
    'npm/vue2-datepicker@3.11.0/locale/vi.js',
  ...
  new Vue({
    ...
    data: {
      variants: {
        'secondary': { action: 'initApp', status: 0, title: 'Init app' },
        ...
        'danger': { action: 'startApp', status: 0, title: 'Start app' },
    ...
    methods: {
      ...
      async loadStore() {
        await Promise.all([
          loadStore('appStore'),
          loadStore('birthdayStore'),
          loadStore('userStore'),
          loadStore('wishQuoteStore'),
          loadStore('templateStore'),
        ]);
      },
